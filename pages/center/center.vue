<template>
	<view class="center">
		...
		<view class="center-list">
			<navigator url="./accountManager" hover-class="center_navitgator">
...
<script>
	...
	export default {
		computed: mapState(['hasLogin', 'nikename', 'avatar']),
		data() {
			return {
				uerInfo: {}
			}
...
<style>
	...
	.center_navitgator {
		-webkit-box-shadow: 3upx 3upx 3upx;  
        -moz-box-shadow: 3upx 3upx 3upx;  
