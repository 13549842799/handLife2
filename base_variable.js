...
// export const baseUrl = 'http://192.168.0.108:8081/O.OBusinessPlan'
...
export const diaryUrl = baseUrl + '/api/article/diary' //日记
export const labelUrl = baseUrl + '/api/article/label' //标签
export const reportUrl = baseUrl + '/api/article/finalresport' //总结
export const novelUrl = baseUrl + '/api/article/novel' //小说
...
export const fileUrl = 'http://www.caiyangzhi.com/img'